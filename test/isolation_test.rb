...
class IsolationTest < Minitest::Test
  def test_clean_gem_uses_released_runtime_dependencies
    ...
    assert_includes output, "runtime dependencies: alhena, alkaid, antares, denebola, editorconfig, gienah, kochab, megrez, menkar, porrima, prism, rexml, rouge, sadr, saiph, spica, tarazed, thuban, timeout, unicode-display_width, zaniah"
  end
