...
class IsolationTest < Minitest::Test
  def test_clean_gem_uses_released_runtime_dependencies
    ...
    assert_includes output, "runtime dependencies: alhena, alkaid, antares, denebola, kochab, porrima, prism, rouge, sadr, spica, tarazed, thuban, unicode-display_width, zaniah"
  end
