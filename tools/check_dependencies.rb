...
expected = %w[alhena alkaid antares denebola editorconfig kochab megrez menkar porrima prism rouge sadr saiph spica tarazed thuban timeout unicode-display_width zaniah]
